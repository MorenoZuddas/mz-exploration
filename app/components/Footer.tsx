    ...
    <footer className="bg-slate-900 text-white py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-center gap-8 mb-8">
          ...
          <a href="https://github.com/MorenoZuddas7" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
            GitHub
          </a>
          <a href="https://www.strava.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
            Strava
          </a>
        </div>
        ...
        <div className="flex justify-center gap-6 mb-8">
          ...
          <a href="mailto:moreno@example.com" className="text-gray-400 hover:text-white transition">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
